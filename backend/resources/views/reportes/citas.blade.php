...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        @foreach($cita['subtipos'] as $subtipo)
                        <li style="margin-bottom: 5px; padding: 5px; border-radius: 3px;">
                            {{ $subtipo['nombre'] }}
                        </li>
                        @endforeach
                    </ul>
            ...
            @empty
            <tr>
                <td colspan="5" style="text-align: center; font-weight: bold;">No hay citas atendidas.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
